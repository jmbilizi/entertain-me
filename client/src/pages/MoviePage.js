...
const MoviePage = () => {
  ...
  async function mediaSearch(title) {
    ...
    const relatedData = await API.relatedSearch(id, mainData.data.results[0].media_type);
    ...
    const trendingData = await API.trendingSearch(mainData.data.results[0].media_type);
    ...
    setState({
      ...
      trending1: `${imageURL}` + trendingInfo.results[0].poster_path,
      trending2:  `${imageURL}` + trendingInfo.results[1].poster_path,
      trending3: `${imageURL}` + trendingInfo.results[2].poster_path,
      trending4:  `${imageURL}` + trendingInfo.results[3].poster_path,
      trending5: `${imageURL}` + trendingInfo.results[4].poster_path,
      trending6:  `${imageURL}` + trendingInfo.results[5].poster_path,
      trending7:  `${imageURL}` + trendingInfo.results[6].poster_path,
      trending8:  `${imageURL}` + trendingInfo.results[7].poster_path,
      trending9:  `${imageURL}` + trendingInfo.results[8].poster_path,
      trending10: `${imageURL}` + trendingInfo.results[9].poster_path,
    });
  }
